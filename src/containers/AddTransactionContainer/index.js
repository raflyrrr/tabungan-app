    ...
    return (
      ...
      <View style={{ height }} >
        ...
        <CategoryModal
          ...
          onIncomePressed={this.onClickMenu.bind(this, 'Pemasukan')}
          onExpensePressed={this.onClickMenu.bind(this, 'Pengeluaran')}
    ...
    >
      <Animated.View style={{ marginHorizontal: 15, marginTop: 15, transform: [{ translateX: formTranslateX }] }}>
        <View style={{ borderBottomWidth: 0.7, borderBottomColor: '#5B3BB4' }}>
          <View>
            <Text style={{ color: '#757575' }}>Kategori</Text>
          </View>
        ...
        <View style={{ borderBottomWidth: 0.7, borderBottomColor: '#5B3BB4', paddingTop: 20 }}>
          <View>
            <Text style={{ color: '#757575' }}>Tanggal</Text>
          </View>
          <View style={{ paddingTop: 10, height: 40 }}>
        ...
        <View style={{ marginTop: 20 }}>
          <Button
            title={checkEditData() ? 'Perbarui' : 'Tambah'}
  ...
  return (
    ...
    >
      <View style={styles.categoryModalview}>
        ...
        >
          <View style={{ flex: 1 }}>
            <Text style={{ color: '#fff', fontSize: 18 }}>Pemasukan</Text>
          </View>
          <View style={{ flex: 2 }}>
            {isActive('Pemasukan') && icon}
          </View>
        ...
        >
          <View style={{ flex: 1 }}>
            <Text style={{ color: '#fff', fontSize: 18 }}>Pengeluaran</Text>
          </View>
          <View style={{ flex: 2 }}>
            {isActive('Pengeluaran') && icon}
          </View>
        </TouchableOpacity>
      </View>
